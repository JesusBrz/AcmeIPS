class CitasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cita.save
        @schedule = Schedule.create(fecha: @cita.fecha, documento_paciente: @cita.documento_paciente, cita_id: @cita.id)
  ...
  def update
    respond_to do |format|
      if @cita.update(cita_params)
        @schedule = Schedule.update(fecha: @cita.fecha)
  ...
  private
    ...
    def cita_params
      params.require(:cita).permit(:nombre_paciente, :documento_paciente, :telefono_paciente, :nombre_medico, :fecha, :tipo)
    end
end
